...
Revision ID: b6be24b5ca60
Revises: 
Create Date: 2026-01-22 16:44:38.767869
...
def upgrade():
    ...
    sa.Column('full_bottle_weight', sa.Float(), nullable=True),
    sa.Column('empty_bottle_weight', sa.Float(), nullable=True),
    sa.Column('shot_weight', sa.Float(), nullable=True),
    sa.Column('shot_volume', sa.Float(), nullable=True),
